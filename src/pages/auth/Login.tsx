...
const LoginPage = () => {
  ...
  return (
    <Box className="min-h-screen" sx={{ bgcolor: '#2E6F69' }} display="flex" alignItems="center" justifyContent="center" p={2}>
      <Paper elevation={6} sx={{ width: 420, borderRadius: 2, p: 4 }}>
        <Box textAlign="center" mb={3}>
          <img src="/imgs/dad_logo_circle.png" alt="Logo" style={{ width: 64, height: 64, margin: '0 auto' }} />
          <Typography variant="h6" sx={{ mt: 1 }}>
            <span style={{ color: '#79C350', fontWeight: 700 }}>License Plate</span>
            <br />
        ...
        <Box mt={2}>
          <Link href="#" underline="hover" color="inherit">ลืมรหัสผ่านหรือไม่?</Link>
        </Box>
